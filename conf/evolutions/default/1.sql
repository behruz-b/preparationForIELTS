...
create table "Rtext" ("ID" SERIAL NOT NULL PRIMARY KEY,"Rtext" VARCHAR(254) DEFAULT '' NOT NULL,"RTitle" VARCHAR(254) DEFAULT '' NOT NULL,"TEXTGROUP_ID" INTEGER NOT NULL);
